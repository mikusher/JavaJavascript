...
public abstract class NeuralLayer {
     ...
     *            Number of Neurons in this Layer
     * @param iaf
     *            Activation Function for all neurons in this Layer
     * @see NeuralLayer
     */
    ...
    protected void init() {
        ...
        if (numberOfNeuronsInLayer >= 0) {
            for (int i = 0; i < numberOfNeuronsInLayer; i++) {
                try {
                    neuron.get(i)
                          .setActivationFunction(activationFnc);
                    neuron.get(i)
                          .init();
     ...
     * 
     * @param inputs
     *            array of real values to be fed into this layer's input
     * @see NeuralInput
     */
     ...
     * 
     * @param i
     *            java index where the Neuron will be placed
     * @param _neuron
     *            Neuron to be inserted or placed in the layer
     */
